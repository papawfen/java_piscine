...
public class Program {
    ...
    public static void main(String[] args) throws FileNotFoundException, SQLException {
        ...
        User creator = new User(2L, "admin", "admin", new ArrayList<>(), new ArrayList<>());
        Chatroom room = new Chatroom(3L, "adm", creator, new ArrayList<>());
        Message message = new Message(1L, creator, room, "aboba", LocalDateTime.now());
        msgRep.save(message);
