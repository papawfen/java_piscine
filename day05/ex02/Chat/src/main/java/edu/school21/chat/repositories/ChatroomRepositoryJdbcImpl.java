...
//    private final String QUERY_TEMPLATE = "SELECT * FROM public.chatroom WHERE chatroom_id=";
    ...
    public Optional<Chatroom> findById(Long id) {
        ...
        try {
            PreparedStatement query = dataSource.prepareStatement("SELECT * FROM public.chatroom WHERE chatroom_id=" + id);
//            query.setLong(1, id);
